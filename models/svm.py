...
class SVM():
    def __init__(self,dataFrame,cv=10):
        ...
        # Assuming a subject ID column named 'subject_id'
        for subject_id in dataFrame['subject_id'].unique():
            ...
            y = subject_data['activityID']  # Replace 'target_variable' with your actual target column name

            # Stratified KFold for balanced class distribution in folds
